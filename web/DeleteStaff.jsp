...
<html>
    ...
    <div class="sidenav">
        ...
        <a href="RegisterStaff.jsp"><i class="fa fa-users" aria-hidden="true"></i>REGISTER STAFF</a><br>
        ...
        <font face="Comic sans MS" size="5">REMOVE EMPLOYEE</p>
        ...
        <div class="input-container">           
            ...
            <input class="input-field" type="text" placeholder="ENTER EMPLOYEE'S STAFF ID" name="staffid" value="<jsp:getProperty name="staff" property="phonenumber"/>"><br>
        </div>
