 ...
 * @author paige
 */
public class Mechanic1 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
             ...
             Task task = new Task();
                ...
                //task.setItems(request.getParameter("items"));
              ...
              //  task.setParts(request.getParameter("parts"));
              // task.setSummary(request.getParameter("summary"));  
               ...
               task.taskReport();
                ...
                RequestDispatcher dispatcher = request.getRequestDispatcher("Mechanic2.jsp");
