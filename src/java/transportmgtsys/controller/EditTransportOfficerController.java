 ...
 * @author GraceTina
 */
@WebServlet(name = "EditTransportOfficerController", urlPatterns = {"/edit/transport/officer"})
public class EditTransportOfficerController extends HttpServlet {
   ...
   private DataSource dataSource;
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (loggedInUser != null) {
            ...
            getServletContext()
                    .getRequestDispatcher("/WEB-INF/jsp/transport_officer/profile_edit.jsp")
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (loggedInUser != null) {
            ...
            getServletContext()
                    .getRequestDispatcher("/WEB-INF/jsp/transport_officer/profile_view.jsp")
                    .forward(request, response);
        } else {
            response.sendRedirect("/login");
        }
