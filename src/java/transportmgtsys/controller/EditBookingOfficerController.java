 ...
 * @author GraceTina
 */
@WebServlet(name = "EditBookingOfficerController", urlPatterns = {"/edit/booking/officer"})
public class EditBookingOfficerController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (loggedInUser != null) {
            ...
            getServletContext()
                    .getRequestDispatcher("/WEB-INF/jsp/booking_officer/profile_edit.jsp")
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (loggedInUser != null) {
            ...
            getServletContext()
                    .getRequestDispatcher("/WEB-INF/jsp/booking_officer/profile_view.jsp")
                    .forward(request, response);
        } else {
            response.sendRedirect("/login");
        }
