 ...
 * @author GraceTina
 */
@WebServlet(name = "EditStaffOfficialController", urlPatterns = {"/edit/staff/official"})
public class EditStaffOfficialController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (loggedInUser != null) {
            ...
            getServletContext()
                    .getRequestDispatcher("/WEB-INF/jsp/staff_official/profile_edit.jsp")
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (loggedInUser != null) {
            ...
            getServletContext()
                    .getRequestDispatcher("/WEB-INF/jsp/staff_official/profile_view.jsp")
                    .forward(request, response);
        } else {
            response.sendRedirect("/login");
        }
